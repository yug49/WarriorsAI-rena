 ...
 */
export { Wordlist } from "ethers/src.ts/wordlists/wordlist";
export { LangEn } from "ethers/src.ts/wordlists/lang-en";

export { WordlistOwl } from "ethers/src.ts/wordlists/wordlist-owl";
export { WordlistOwlA } from "ethers/src.ts/wordlists/wordlist-owla";

export { wordlists } from "ethers/src.ts/wordlists/wordlists";
